...
export type Action = 'scan_config' | 'scan_plugins' | 'scan_sessions' | 'scan_network' | 'report' | 'rules';
...
export type SkipReason = 'not-applicable' | 'platform' | 'permission' | 'budget' | 'config';
