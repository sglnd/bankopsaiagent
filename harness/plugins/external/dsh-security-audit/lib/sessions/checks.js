...
import { readHeadCapped, throwIfAborted, throwIfDeadlineExceeded } from '../paths.js';
import { redactPath, safeErrorMessage } from '../redact.js';
import { RULE_BY_CODE } from '../rules.js';
import { discoverSessions, sessionsRootOf } from './discover.js';
import { analyzeZstd } from './zstd-scan.js';
import { checkDirPermissions, checkSessionFilePermissions } from '../platform/permissions.js';
export async function scanSessions(ctx) {
    const checks = [];
    const findings = [];
...
export { isTempResidue } from './zstd-scan.js';
