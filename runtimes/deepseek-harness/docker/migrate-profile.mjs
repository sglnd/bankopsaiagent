...
const common = [
  ...
  ['@bankops/dsh-system-inspection', 'link:/opt/bankops/plugins/bankops-system-inspection'],
  ['@bankops/dsh-user-skills', 'link:/opt/bankops/plugins/bankops-user-skills'],
  ['@bankops/dsh-knowledge-memory', 'link:/opt/bankops/plugins/bankops-knowledge-memory'],
]
