...
for profile in web headless dev; do
  ...
  ln -sfn /opt/bankops/plugins/bankops-system-inspection "$modules/@bankops/dsh-system-inspection"
  ln -sfn /opt/bankops/plugins/bankops-user-skills "$modules/@bankops/dsh-user-skills"
  ln -sfn /opt/bankops/plugins/bankops-knowledge-memory "$modules/@bankops/dsh-knowledge-memory"
